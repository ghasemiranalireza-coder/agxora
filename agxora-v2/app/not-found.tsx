...
/** Global 404 — public + app error surface with recovery to landing. */
export default function NotFound(): JSX.Element {
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse at top, rgba(34,211,238,0.08), transparent 55%), #05070d",
        color: "#f8fafc",
      }}
    >
